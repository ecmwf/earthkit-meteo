...
**earthkit-meteo** is a Python package providing meteorological computations using array (NumPy, Torch and CuPy), xarray or fieldlist. It is part of the [earthkit](https://github.com/ecmwf/earthkit) ecosystem.
