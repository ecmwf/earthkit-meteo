...
def interpolate_k2p(
    ...
    field_on_tc = _init_field_with_vcoord(field.broadcast_like(p_field), tc, np.nan)
...
def interpolate_k2theta(
    ...
    # Prepare output field field_on_tc on target coordinates
    field_on_tc = _init_field_with_vcoord(field.broadcast_like(th_field), tc, np.nan)
...
def interpolate_k2any(
    ...
    # Prepare output field field_on_tc on target coordinates
    field_on_tc = _init_field_with_vcoord(field.broadcast_like(tc_field), tc, np.nan)
